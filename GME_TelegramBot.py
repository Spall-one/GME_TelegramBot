...
async def vincitore(update: Update, context: CallbackContext):
    ...
    # Se si tratta di oggi e il mercato è ancora aperto, blocca
    ...
    # Mostra il risultato già calcolato se esiste
    ...
    # Raccoglie le previsioni per la data
    ...
    # Controllo se c'è un "perfect guess"
    ...
    if perfect_guesser:
        ...
        # Aggiorna il bilancio del vincitore perfetto
        c.execute("""
        ...
        # Sottrae le perdite agli sconfitti
